            ...
            <div className="grid grid-cols-12 gap-4 sm:gap-6 md:gap-8 w-full">
                <ItemLayout className="col-span-full lg:col-span-8 row-span-2 flex-col items-start">
                    ...
                    <p className='font-light text-left w-full text-xs sm:text-sm md:text-base'>
                        I am one of the ambitious people who did not
                        give up easily. I always works to develop myself
                        and I do not stop at one point where I strive
                ...
                <ItemLayout className="col-span-full xs:col-span-6 lg:col-span-4 text-accent">
                    ...
                    <p className='font-semibold w-full text-left text-2xl sm:text-5xl'>
                        +{date.getFullYear() - 2021} <sub className='font-semibold text-base'>
                            years of experience
                        </sub>
                    </p>
